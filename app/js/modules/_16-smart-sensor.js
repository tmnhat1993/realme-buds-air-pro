export default class SmartSensor {
    ...
    InitSection() {
        ...
        // Background
        this.SmartSensorAnimation.fromTo(this.$Effect_MainImg, 0.75, { x: this.DISTANCE * 0.1, alpha: 0 }, { x: 0, alpha: 1 }, 'anim-start');
        this.SmartSensorAnimation.fromTo(this.$Effect_ContentBg, 0.75, { x: -this.DISTANCE * 0.3, alpha: 0 }, { x: 0, alpha: 1 }, 'anim-start+=0.1');
